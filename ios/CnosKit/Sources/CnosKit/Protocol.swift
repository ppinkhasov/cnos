...
public struct TerminalInfo: Codable, Sendable, Identifiable, Hashable {
    ...
    public init(id: String, name: String, agentType: String? = nil, role: String? = nil,
                promptId: String? = nil, promptLabel: String? = nil, cwd: String? = nil) {
        self.id = id; self.name = name; self.agentType = agentType; self.role = role
...
/// One agent's live state inside the orchestration snapshot.
public struct FleetAgent: Codable, Sendable, Identifiable, Hashable {
    public let id: String
    public var name: String
    public var role: String
    public var agentType: String?
    public var state: String      // idle | working | busy | thinking
    public var task: String?
}

/// One line of the orchestrator activity feed.
public struct OrchLogEntry: Codable, Sendable, Hashable, Identifiable {
    public var t: Double          // ms epoch
    public var kind: String       // start | assign | lead | done | spawn | note | warn | …
    public var text: String
    // Stable enough for SwiftUI ForEach within a single session.
    public var id: String { "\(t)-\(kind)-\(text)" }
}

/// Full orchestration snapshot (the `orchestration` message).
public struct Orchestration: Codable, Sendable {
    public var enabled: Bool
    public var running: Bool
    public var resumable: Bool?
    public var status: String     // idle | briefing | running | done | stopped | stalled | error
    public var goal: String?
    public var workerType: String?
    public var workdir: String?
    public var startWorkers: Int?
    public var maxAgents: Int?
    public var round: Int?
    public var agents: Int?
    public var fleet: [FleetAgent]
    public var log: [OrchLogEntry]

    public static let empty = Orchestration(
        enabled: false, running: false, resumable: false, status: "idle",
        goal: nil, workerType: nil, workdir: nil, startWorkers: nil, maxAgents: nil,
        round: nil, agents: nil, fleet: [], log: []
    )
}
...
extension ServerMessage: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "orchestration":
            self = .orchestration(try Orchestration(from: decoder))
        default:
...
/// Config block for `set-orchestration` (mid-run edits are ignored by the server).
public struct OrchConfig: Encodable, Sendable {
    public var goal: String?
    public var workerType: String?
    public var startWorkers: Int?
    public var maxAgents: Int?
    public init(goal: String? = nil, workerType: String? = nil, startWorkers: Int? = nil, maxAgents: Int? = nil) {
        self.goal = goal; self.workerType = workerType
        self.startWorkers = startWorkers; self.maxAgents = maxAgents
    }
}
...
public enum ClientMessage: Encodable, Sendable {
    ...
    case list
    case setOrchestration(enabled: Bool? = nil, config: OrchConfig? = nil)
    case orchestrateStart(goal: String, workerType: String? = nil, workdir: String? = nil,
                          startWorkers: Int? = nil, maxAgents: Int? = nil)
    case orchestrateStop
    case orchestrateResume
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .list:
            try put("list", "type")
        case let .setOrchestration(enabled, config):
            try put("set-orchestration", "type")
            try putIf(enabled, "enabled"); try putIf(config, "config")
        case let .orchestrateStart(goal, workerType, workdir, startWorkers, maxAgents):
            try put("orchestrate-start", "type"); try put(goal, "goal")
            try putIf(workerType, "workerType"); try putIf(workdir, "workdir")
            try putIf(startWorkers, "startWorkers"); try putIf(maxAgents, "maxAgents")
        case .orchestrateStop:
            try put("orchestrate-stop", "type")
        case .orchestrateResume:
            try put("orchestrate-resume", "type")
        }
    }
}
